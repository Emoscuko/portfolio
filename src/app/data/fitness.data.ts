...
export const FITNESS_TIMELINE: TimelineItem[] = [
    ...
    {
        year: "2025",
        title: "Advanced Nutrition & Content Start",
        titleTr: "İleri Beslenme ve İçerik Başlangıcı",
        subtitle: "Strict Protocol & Social Media",
        subtitleTr: "Katı Protokol ve Sosyal Medya",
        description: "Deep-dived into science-based lifting and followed a very strict, fixed-meal diet with zero junk food. Also started my handstand progression series and opened the fitness side on social media.",
        descriptionTr: "Science-based lifting araştırmaları yapıp uygulamaya başladım. Çok katı ve sağlıklı bir diyet uyguluyordum, paketli gıdaları tamamen bıraktım, amuda kalkma serisine başladım ve fitness tarafında sosyal medyaya giriş yaptım.",
        type: "work",
        tags: ["Science-Based", "Handstand", "Social Media"],
    },
    {
        year: "2026",
        title: "Peak Conditioning & Audience",
        titleTr: "Zirve Form ve Kitle",
        subtitle: "Stability, Mastery & Consistent Posting",
        subtitleTr: "Denge, Ustalık ve Düzenli Paylaşım",
        description: "Focusing on smaller stabilizer muscles that were previously weak. Can now hold a solid handstand, moved on to handstand push-up training, started posting consistently, and built a small fitness audience.",
        descriptionTr: "Vücudumdaki zayıf kalmış denge ve küçük kas gruplarını geliştirmeye odaklandım. Artık amuda kalkabiliyorum, amutta şınav serisine geçtim, düzenli içerik paylaşmaya başladım ve küçük bir fitness kitlesi edindim.",
        type: "certification",
        tags: ["Aesthetics", "Calisthenics", "Content"],
    }
];
